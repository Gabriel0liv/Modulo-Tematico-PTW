...
<div class="w-64 bg-sidebar border-r border-gray-200 h-full flex flex-col">
    <div class="border border-gray-300 rounded-xl p-2 space-y-1 bg-white">
        ...
        <nav class="flex-1 p-4">
            <ul class="space-y-1">
                <li>
                    <a href="/perfilAdmin/denuncias" class="flex items-center gap-3 px-4 py-3 rounded-md transition-colors
                ...
                <li>
                    <a href="/perfilAdmin/estatisticas" class="flex items-center gap-3 px-4 py-3 rounded-md transition-colors
                ...
                <li>
                    <a href="/perfilAdmin/aprovar" class="flex items-center gap-3 px-4 py-3 rounded-md transition-colors
                ...
                <li>
                    <a href="/perfilAdmin/perfilA" class="flex items-center gap-3 px-4 py-3 rounded-md transition-colors
                ...
                <li>
                    <a href="/perfilAdmin/Edicao" class="flex items-center gap-3 px-4 py-3 rounded-md transition-colors
