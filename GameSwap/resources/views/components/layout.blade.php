...
<body class="flex flex-col min-h-screen">
  <header class="bg-gradient-to-r from-blue-600 to-blue-500 py-3 px-4 shadow-md">
      ...
      <!-- Login Modal -->
      <div id="login-modal" class="login-modal fixed inset-0 z-50 flex items-center justify-center">
          <div class="login-modal-content bg-white rounded-xl shadow-elevated max-w-md w-full mx-4 overflow-hidden">
              <div class="p-6">
                  <h2 class="text-2xl font-bold text-neutral-800 text-center mb-6">Iniciar Sessão</h2>
                  ...
                  <form id="login-form">
                      <div class="space-y-4">
                          <div>
                              <label for="username" class="block text-sm font-medium text-neutral-700 mb-1">Nome de usuário:</label>
                              <input type="text" id="username" class="w-full border border-neutral-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" placeholder="Seu nome de usuário">
                          </div>
                          <div>
                              <label for="password" class="block text-sm font-medium text-neutral-700 mb-1">Palavra passe:</label>
