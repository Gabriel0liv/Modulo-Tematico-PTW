        ...
        <form action="{{route('user.atualizar')}}" method="post">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="password" name="password" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="">
