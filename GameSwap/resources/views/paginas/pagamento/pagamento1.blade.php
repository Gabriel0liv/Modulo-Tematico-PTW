        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <div class="p-6 pt-0">
            <form class="space-y-4">
              ...
              <a href="/paginas/pagamento/pagamento2" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full bg-blue-600 hover:bg-blue-700 text-white">
