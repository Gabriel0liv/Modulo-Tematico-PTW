    ...
    <main class="flex-1 overflow-auto">
      <div class="container mx-auto py-8 px-6 max-w-4xl">
        <div class="flex justify-between items-center mb-8">
          ...
          <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary-hover h-10 px-4 py-2">
          ...
          <div class="rounded-lg border border-primary/50 bg-primary-light/30 text-card-foreground shadow-card">
            <div class="flex flex-row items-center justify-between p-6 pb-2">
              <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold leading-none tracking-tight">Casa</h3>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-card">
            <div class="flex flex-row items-center justify-between p-6 pb-2">
              <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold leading-none tracking-tight">Trabalho</h3>
              </div>
              <div class="flex items-center gap-2">
                <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium text-gray-500 bg-transparent hover:bg-gray-100 h-8 w-8 p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-6 pt-0">
              <div class="space-y-1 text-gray-700">
                <p>Avenida da República, 45, 3º Esq</p>
                <p>1050-234, Lisboa</p>
                <p>Portugal</p>
              </div>
          ...
          <div class="rounded-lg border bg-card text-card-foreground shadow-card">
            <div class="flex flex-row items-center justify-between p-6 pb-2">
              <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold leading-none tracking-tight">Casa dos Pais</h3>
              </div>
              <div class="flex items-center gap-2">
                <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium text-gray-500 bg-transparent hover:bg-gray-100 h-8 w-8 p-0">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
