<x-layout>
        ...
        <main id="aprovar-anuncios" class="mb-10">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                    <button id="anunciosPendentesBtn" class="bg-blue-600 text-white px-4 py-2 rounded-md" onclick="mostrar('pendentes', this)">Pendentes</button>
                    <button id="anunciosAprovadosBtn" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-md" onclick="mostrar('aprovados', this)">Aprovados</button>
                    <button id="anunciosRejeitadosBtn" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-md" onclick="mostrar('rejeitados', this)">Rejeitados</button>
                </div>
            </div>
    ...
    <script>
        ...
        // Exibe a seção "pendentes" por padrão ao carregar a página
