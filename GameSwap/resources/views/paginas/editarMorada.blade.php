            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="nome_morada" name="nome_morada" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="{{$morada->nome_morada}}" required>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="morada" name="morada" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="{{$morada->morada}}" required>
                    </div>

                    <div>
                        <label for="codigo_postal" class="block text-sm text-gray-600 mb-1">Código Postal</label>
                        <input type="text" id="codigo_postal" name="codigo_postal" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="{{$morada->codigo_postal}}" required>
                    </div>
